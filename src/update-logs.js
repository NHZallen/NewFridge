...
export const UPDATE_LOGS = [
  ...
  },
  {
    version: "1.16.0",
    date: "2026-03-05",
    title: "介面現代化與操作體驗全面升級",
    changes: [
      "介面升級：首頁搜尋欄位大幅翻新，導入「現代化膠囊容器」設計，融合區域篩選與過濾，視覺更滑順",
      "介面升級：統一底部多選工具區 (Action Island) 的外觀風格，讓操作體驗與購物車保持一致",
      "通知系統優化：重啟分級保護！系統通知將依照成功、警告、錯誤 (紅黃綠) 明確提示狀態，並縮短了干擾時間",
      "新增功能：首頁「無庫存品」專區現在也支援搜尋與過濾了，快速尋找已食畢的品項"
    ]
  },
  {
    version: "1.15.1",
